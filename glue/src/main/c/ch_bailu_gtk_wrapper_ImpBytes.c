...
#include "ch_bailu_gtk_wrapper_ImpBytes.h"


JNIEXPORT jlong JNICALL Java_ch_bailu_gtk_wrapper_ImpBytes_createBytes
...
JNIEXPORT jbyte JNICALL Java_ch_bailu_gtk_wrapper_ImpBytes_getByte

...
#include "ch_bailu_gtk_type_ImpStr.h"


/**
    Copy a Java String to a heap memory region in c-space
*/
JNIEXPORT jlong JNICALL Java_ch_bailu_gtk_type_ImpStr_createStr
...
*/
JNIEXPORT jstring JNICALL Java_ch_bailu_gtk_type_ImpStr_toString

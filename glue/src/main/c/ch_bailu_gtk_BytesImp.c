...
#include "ch_bailu_gtk_BytesImp.h"


JNIEXPORT jlong JNICALL Java_ch_bailu_gtk_BytesImp_createBytes
...
JNIEXPORT jbyte JNICALL Java_ch_bailu_gtk_BytesImp_getByte
...
JNIEXPORT void JNICALL Java_ch_bailu_gtk_BytesImp_destroy

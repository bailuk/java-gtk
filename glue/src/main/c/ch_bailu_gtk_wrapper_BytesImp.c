...
#include "ch_bailu_gtk_wrapper_BytesImp.h"


JNIEXPORT jlong JNICALL Java_ch_bailu_gtk_wrapper_BytesImp_createBytes
...
JNIEXPORT jbyte JNICALL Java_ch_bailu_gtk_wrapper_BytesImp_getByte
